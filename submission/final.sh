...
TAPROOT_ADDR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getnewadrress "" bech32m)
...
COLLECTED=$(echo "$NEW_BALACE - $BALANCE" | bc)
...
# WRITE YOUR SOLUTION BELOW:
INTERNAL_KEY=$(echo "$ADDR_INFO" | jq -r '.taproot.internal_key')
